...
internal sealed class EntitiesForEachQuery
{
        ...
        out EntitiesForEachQuery query)
    {
        ...
        var componentData = semanticModel.Compilation.GetTypeByMetadataName("Unity.Entities.IComponentData");
        var entityType = semanticModel.Compilation.GetTypeByMetadataName("Unity.Entities.Entity");
    ...
    {
        statement = null!;
        if (semanticModel.Compilation.GetTypeByMetadataName("Unity.Entities.SystemAPI") is null ||
            semanticModel.Compilation.GetTypeByMetadataName("Unity.Entities.RefRO`1") is null ||
            semanticModel.Compilation.GetTypeByMetadataName("Unity.Entities.RefRW`1") is null)
        {
            return false;
        }
...
internal sealed class JobEntityExecution
{
        ...
        out JobEntityExecution execution)
    {
        ...
        var jobEntity = semanticModel.Compilation.GetTypeByMetadataName("Unity.Entities.IJobEntity");
